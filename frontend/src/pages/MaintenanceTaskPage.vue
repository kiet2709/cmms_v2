...
import MaintenanceViewer from './MaintenanceViewer.vue';
...
async function fetchDailyTasks() {
  ...
  try {
    const res = await axiosClient.get('', {
      params: { c: 'MaintenanceController', m: 'getMachineTaskBySessionId', session_id: props.uuid }
    });
      ...
      <div class="table-container">
        <div class="table-responsive">
          <table class="modern-table">
            <thead>
              <tr>
                <th>Code</th><th>Description</th><th>Type</th><th>Date Start</th>
                <th>Inspected Date</th><th>Status</th><th>Result</th><th>Inspector</th><th>Actions</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="task in filteredData" :key="task.uuid">
